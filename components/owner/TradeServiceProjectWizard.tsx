...
export function TradeServiceProjectWizard({ trade }: TradeServiceProjectWizardProps) {
  ...
  function validatedTradeDetails() {
    ...
    return validateTradeDetailsInput({
      ...
      waterTankConnections: form.waterTankConnections,
      motorConnections: form.motorConnections,
      ...
      inverterConnectionPoints: form.inverterConnectionPoints,
      mainDistributionBoxCount: form.mainDistributionBoxCount,
