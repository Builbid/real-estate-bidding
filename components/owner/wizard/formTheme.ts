/** Shared new-project form surfaces — white cards, brand accents on actions only. */
export const FORM_SECTION_CARD =
  'rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-3 dark:border-gray-200 dark:bg-white';
...
export const FORM_NESTED_PANEL =
  'space-y-3 rounded-xl border border-gray-200 bg-white p-3 dark:border-gray-200 dark:bg-white';

export const FORM_CHECKBOX =
  'mt-0.5 h-4 w-4 rounded border-border text-brand focus:ring-brand';

export const FORM_TEXTAREA =
  'w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-900 dark:text-zinc-100 placeholder:text-slate-600 dark:placeholder:text-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:border-brand';

export const FORM_PROGRESS_DONE = 'bg-brand text-white';
export const FORM_PROGRESS_CURRENT =
  'border-2 border-brand text-brand bg-white';
export const FORM_PROGRESS_IDLE = 'border border-gray-200 bg-white text-slate-400';
export const FORM_PROGRESS_LINE = 'h-px flex-1 bg-gray-200 mx-1 min-w-[8px]';
