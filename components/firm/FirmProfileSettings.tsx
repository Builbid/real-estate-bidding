...
import { getConstructionClassTitle } from '@/lib/firm/constructionClass';
...
interface FirmProfileSettingsProps {
  ...
  constructionClass: FinishingLevel | null;
  logoUrl: string | null;
  fullName: string;
}
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <dl className="space-y-3 text-sm">
          ...
          <div className="flex justify-between gap-4 py-2 border-b border-border">
            <dt className="text-muted-foreground">Construction Class</dt>
            <dd className="font-semibold text-foreground text-right">
              {constructionClass ? getConstructionClassTitle(constructionClass) : '—'}
            </dd>
          </div>
