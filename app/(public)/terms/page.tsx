    ...
    >
      ...
      <StaticSection title="2. About BuilBid">
        <p>
          ...
          between clients and bidders (mistri workers and construction firms).
      ...
      <StaticSection title="4. User roles & responsibilities">
        ...
        <p><strong className="text-foreground">Mistri workers & construction firms</strong> agree to:</p>
