    ...
    >
      ...
      <StaticSection title="2. Information we collect">
        ...
        <ul className="list-disc pl-5 space-y-2 mt-2">
          <li><strong className="text-foreground">Account information:</strong> name, email address, mobile number, password (stored securely hashed), role (owner, labour contractor, or construction firm).</li>
